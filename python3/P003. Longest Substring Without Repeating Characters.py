...
#1.3
"""
Runtime: 328 ms, faster than 18.39% of Python3 online submissions for Longest Substring Without Repeating Characters.
Memory Usage: 17.5 MB, less than 5.10% of Python3 online submissions for Longest Substring Without Repeating Characters.
"""
	def lengthOfLongestSubstring(self, s):
		unrepeated_substring = []
		substring = ""
